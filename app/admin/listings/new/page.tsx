...
export default function NewListingPage() {
  ...
  if (!activeShowroom) {
    return (
      <div className="max-w-2xl mx-auto py-8 text-center">
        <p className="text-neutral-600">Sélectionnez une boutique.</p>
      </div>
    );
  }
    ...
    <div className="max-w-xl">
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-5">
        ...
        <div>
          ...
          <select value={status} onChange={(e) => setStatus(e.target.value as 'draft' | 'published')} className="w-full max-w-[200px] px-4 py-2.5 rounded-lg border border-neutral-200 bg-white text-neutral-900 focus:outline-none focus:ring-2 focus:ring-neutral-900">
